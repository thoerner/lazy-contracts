...
abstract contract ERC721EnumerableLiteB is ERC721C, IERC721Batch, IERC721Enumerable {
    ...
    function totalSupply() public view virtual override( ERC721C, IERC721Enumerable ) returns (uint) {
