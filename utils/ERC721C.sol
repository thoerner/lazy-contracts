...
abstract contract ERC721C is Context, ERC165, IERC721, IERC721Metadata {
    ...
    constructor(string memory name_, string memory symbol_, uint totalTokens) {
        _name = name_;
        _symbol = symbol_;
        _owners = new address[](totalTokens);
    }
    ...
    function _mint(address to, uint tokenId) internal virtual {
        ...
        require(
            ...
            "ERC721: tokenId exceeds total tokens"
        );

        _beforeTokenTransfer(address(0), to, tokenId);

        _owners[tokenId] = to; // Set the owner at the specific tokenId position
